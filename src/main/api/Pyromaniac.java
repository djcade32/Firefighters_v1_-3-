...
public class Pyromaniac {
  ...
  /**
   * Sets a number of fires {@param numFires} at {@param victimLocations} in the
   * given {@param victimCity}
   *
   * @param victimCity      City to be set on fire
   * @param victimLocations Locations to be set on fire
   * @throws FireproofBuildingException if one of the buildings in question is
   *                                    fireproof
   */
  public static void setFires(City victimCity, CityNode[] victimLocations) throws FireproofBuildingException {
